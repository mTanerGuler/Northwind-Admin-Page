...
app.get('/orders', (request, response) => { //http://localhost:3000/orders
    //get isteğinin body bilgisi olmaz 
    //header bilgisi olur bu header bilgisinde paylaşılacak datanın tipi belirtilir.
    var model = [];
    ...
    orders.forEach(order => {
        ...
        var employee = employeesArr.find(x => x.employeeId === order.employeeId);
...
app.get('/employees', (request, response) => {
    ...
    employeesArr.forEach(employee => {
        ...
        empData['id'] = employee.employeeId;
        empData['employeeName'] = employee.firstName + " " + employee.lastName;
...
app.listen(3000, () => {
    console.log("Merhaba ben 5000 portuna yapılan istekleri dinliyorum.")
});